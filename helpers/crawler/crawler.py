...
This module provides the `Crawler` class, which is responsible for parsing
album pages, extracting image links, and handling reloaded pages.
"""
...
class Crawler:
    ...
    This class fetches and processes album pages, retrieves album names,
    and handles reloaded image pages.
    """
